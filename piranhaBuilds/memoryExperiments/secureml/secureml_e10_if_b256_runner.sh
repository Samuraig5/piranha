...
#CUDA_VISIBLE_DEVICES=3 ./piranha -p 3 -c piranhaBuilds/memoryExperiments/secureml/4pc_secureml_e10_if_b256_config.json >/dev/null &
#CUDA_VISIBLE_DEVICES=2 ./piranha -p 2 -c piranhaBuilds/memoryExperiments/secureml/3pc_secureml_e10_if_b256_config.json >/dev/null &
CUDA_VISIBLE_DEVICES=1 ./piranha -p 1 -c piranhaBuilds/memoryExperiments/secureml/2pc_secureml_e10_if_b256_config.json >/dev/null &
CUDA_VISIBLE_DEVICES=0 ./piranha -p 0 -c piranhaBuilds/memoryExperiments/secureml/2pc_secureml_e10_if_b256_config.json