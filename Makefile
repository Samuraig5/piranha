...
CXX=/scicore/soft/apps/CUDA/$(CUDA_VERSION)/bin/nvcc
...
OBJ_INCLUDES := -I '/scicore/soft/apps/CUDA/$(CUDA_VERSION)/include' -I '$(CUTLASS_PATH)/include' -I '$(CUTLASS_PATH)/tools/util/include' -I 'include' -I /scicore/home/s-gpu-course/moser0016/libs/include
INCLUDES := $(OBJ_INCLUDES), -L./ -L/scicore/soft/apps/CUDA/$(CUDA_VERSION)/lib64 -L$(CUTLASS_PATH)/build/tools/library -L /scicore/home/s-gpu-course/moser0016/libs/lib64
